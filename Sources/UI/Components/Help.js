...
#### Formatting
The cards can be formatted with HTML / CSS or with markdown. Basic LaTeX math is also supported via KaTeX. In addition to that these features are also supported:
