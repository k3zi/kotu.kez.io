                        ...
                        return (<div key={i}>
                            ...
                            <div className='d-flex align-items-center mb-2 text-muted'>
                                ...
                                {user && user.permissions.includes('blog') && <LinkContainer style={{cursor:'pointer'}} exact to={`/article/edit/${post.id}`}>
                                    <span className='text-primary ps-2'>Edit <i className="bi bi-pencil-square"></i></span>
                                </LinkContainer>}
                                {user && user.permissions.includes('blog') && <span style={{cursor:'pointer'}} onClick={() => this.showDeletePostModal(post)} className='text-danger ps-2'>Delete <i className="bi bi-trash"></i></span>}
                            </div>
